...
@section('content')
    <div class="container mt-5 mb-5">
        <div class="d-flex mt-3 mb-3 justify-content-end gap-3">
            ...
            <a href="{{ route('vendor.dashboard') }}" class="btn btn-outline-dark">Home</a>
        </div>
                ...
                <div class="container mb-5 mt-3">
                    <div class="row d-flex align-items-baseline">
                        ...
                        <div class="col-xl-3 float-end">
                            ...
                            <a href="{{ route('vendor.bills.download', ['id' => $data->id]) }}" data-mdb-ripple-init
                                class="btn btn-light text-capitalize" data-mdb-ripple-color="dark">
                                <i class="far fa-file-pdf text-danger"></i> Export to PDF
                            </a>

                            <!-- Email Button -->
                            <a href="{{ route('vendor.bills.mail', ['data' => $data]) }}" data-mdb-ripple-init
                                class="btn btn-light text-capitalize" data-mdb-ripple-color="dark">
