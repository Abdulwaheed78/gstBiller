    ...
    <div class="container mt-5 mb-5" style="height: 70vh;">
        <div class="card mx-auto mt-5 mb-5">
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('vendor.bills.updatepro', ['id' => $data->id]) }}"
                    enctype="multipart/form-data">
                    <input type="hidden" name="bill_id" value="{{ $data->bill_id }}">
                    @csrf
                    <input type="hidden" name="old_final" id="old_final" value="{{ $bill->f_amount }}">
                    <!-- Fixed this line -->
                    <!-- Static Header Row -->
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-2 col-6">
                            <input type="number" name="gst_rate" class="form-control" value="{{ $data->gst_rate }}"
                                required>
                        </div>
                        <div class="col-md-2 col-6">
                    ...
                    <div class="d-flex justify-content-end mt-5 gap-3">
                        ...
                        <a href="{{ route('vendor.bills.edit', ['id' => $bill->id]) }}"
