...
@endsection
@section('content')
    <div class="container mt-5 mg-5" style="height: 100vh; overflow-y: auto;">
        <div class="card" >
            <div class="card-body">
                <h4 class="mb-3">Add Bill Products</h4>
                <form method="POST" action="{{ route('vendor.bills.createpro', ['id' => $id]) }}" enctype="multipart/form-data">
                    ...
                    <div class="d-flex justify-content-end mb-3">
                        <div class="col-3">
                            ...
                            <label for="grandamount">Grand Final Amount</label>
                        </div>
                    </div>
                    <!-- Static Header Row -->
                    ...
                    <div class="d-flex justify-content-end mt-5 gap-3">
                        <button type="button" class="btn btn-outline-warning" id="addRowBtn">Add Row</button>
                        <button type="submit" class="btn btn-outline-primary ml-3">Save</button>
                        <a href="{{ route('vendor.bills.edit', ['id' => $id]) }}" class="btn btn-outline-danger ml-3">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        ...
        $('#addRowBtn').click(function() {
            ...
            <div class="row mb-3" id="row-${rowIndex}">
              ...
              <div class="col-md-1">
                <button type="button" class="btn btn-outline-danger btn-sm deleteRowBtn" data-row-id="row-${rowIndex}">Delete</button>
              </div>
            </div>
          `;
